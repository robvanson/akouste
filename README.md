...
A NPM registry derived SBOM can be downloaded from the [GitHub akoúste dependency graph](https://github.com/robvanson/akouste/network/dependencies), based on the NPM [package-lock.json](package-lock.json) file [^8].
