...
[^3]: The converter [*markdown-it.min.js*](https://cdn.jsdelivr.net/npm/markdown-it@14.1.0/dist/) can be stored locally if desired. This is done in the Git repository to reduce the dependence on linked outside sources. Be aware that the version in the *akoúste* repository can be outdated.  
