...
[^6]: The **Restart** button can be made visible to abort a running experiment by clicking 7 times on the green spot on the bottom right of the page. The **Restart** button will disappear again when clicking the **Next** button if this action should be canceled.
